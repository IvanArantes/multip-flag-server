...
public class PlayerMovement : MonoBehaviour
{
    ...
    {
        Vector3 moveDirection = Vector3.Normalize(camProxy.right * inputDirection.x + camProxy.forward * inputDirection.y);
    ...
    /// Send the clients the position and where they are facing
