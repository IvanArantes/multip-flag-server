...
public class Player : MonoBehaviour
{
    ...
    public static void Spawn(ushort id, string username)
    {
        ...
        {
            //this is to new palyers know the spawn location
        ...
        // sending this only notifies players alredy connected, for new players, they wont know the existing positions
        player.SendSpawned();
        list.Add(id, player);
    }
